...
const (
	...
	ModuleName                      = wasmplustypes.ModuleName
	StoreKey                        = wasmplustypes.StoreKey
	TStoreKey                       = types.TStoreKey
	QuerierRoute                    = types.QuerierRoute
	RouterKey                       = wasmplustypes.RouterKey
...
var (
	// functions aliases
	RegisterCodec             = wasmplustypes.RegisterLegacyAminoCodec
	RegisterInterfaces        = wasmplustypes.RegisterInterfaces
	ValidateGenesis           = wasmplustypes.ValidateGenesis
	...
	InitGenesis               = wasmpluskeeper.InitGenesis
	ExportGenesis             = wasmpluskeeper.ExportGenesis
	...
	NewKeeper                 = wasmpluskeeper.NewKeeper
	...
	WasmQuerier               = wasmpluskeeper.WasmQuerier
	CreateTestInput           = wasmpluskeeper.CreateTestInput
	TestHandler               = wasmpluskeeper.TestHandler
	NewWasmProposalHandler    = wasmpluskeeper.NewWasmProposalHandler
	NewQuerier                = wasmpluskeeper.Querier
	...
	EnableAllProposals   = wasmplustypes.EnableAllProposals
	DisableAllProposals  = types.DisableAllProposals
)

type (
	ProposalType                   = types.ProposalType
	GenesisState                   = wasmplustypes.GenesisState
	Code                           = types.Code
	...
	MsgServer                      = wasmplustypes.MsgServer
	Model                          = types.Model
