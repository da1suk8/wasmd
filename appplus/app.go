...
var (
	...
	_ runtime.AppI            = (*WasmPlusApp)(nil)
...
func NewWasmApp(
	...
	*/
	...
	app.ModuleManager = module.NewManager(
		...
		wasmplus.NewAppModule(appCodec, &app.WasmKeeper, app.StakingKeeper, app.AccountKeeper, app.BankKeeper, app.MsgServiceRouter(), app.GetSubspace(wasmtypes.ModuleName)),
...
func (app *WasmPlusApp) FinalizeBlock(req *abci.RequestFinalizeBlock) (*abci.ResponseFinalizeBlock, error) {
...
func (app *WasmPlusApp) setAnteHandler(txConfig client.TxConfig, wasmConfig wasmtypes.WasmConfig, txCounterStoreKey *storetypes.KVStoreKey) {
...
func (app *WasmPlusApp) setPostHandler() {
...
func (app *WasmPlusApp) PreBlocker(ctx sdk.Context, _ *abci.RequestFinalizeBlock) (*sdk.ResponsePreBlock, error) {
	return app.ModuleManager.PreBlock(ctx)
}

// BeginBlocker application updates every begin block
func (app *WasmPlusApp) BeginBlocker(ctx sdk.Context) (sdk.BeginBlock, error) {
	return app.ModuleManager.BeginBlock(ctx)
}

// EndBlocker application updates every end block
func (app *WasmPlusApp) EndBlocker(ctx sdk.Context) (sdk.EndBlock, error) {
	return app.ModuleManager.EndBlock(ctx)
}

func (a *WasmPlusApp) Configurator() module.Configurator {
	return a.configurator
}

// InitChainer application update at chain initialization
func (app *WasmPlusApp) InitChainer(ctx sdk.Context, req *abci.RequestInitChain) (*abci.ResponseInitChain, error) {
...
// InterfaceRegistry returns WasmPlusApp's InterfaceRegistry
func (app *WasmPlusApp) InterfaceRegistry() types.InterfaceRegistry {
	return app.interfaceRegistry
}

// TxConfig returns WasmApp's TxConfig
func (app *WasmPlusApp) TxConfig() client.TxConfig {
	return app.txConfig
}

// AutoCliOpts returns the autocli options for the app.
func (app *WasmPlusApp) AutoCliOpts() autocli.AppOptions {
...
func (a *WasmPlusApp) DefaultGenesis() map[string]json.RawMessage {
...
func (app *WasmPlusApp) GetKey(storeKey string) *storetypes.KVStoreKey {
	return app.keys[storeKey]
}

// GetStoreKeys returns all the stored store keys.
func (app *WasmPlusApp) GetStoreKeys() []storetypes.StoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *WasmPlusApp) GetTKey(storeKey string) *storetypes.TransientStoreKey {
...
func (app *WasmPlusApp) GetMemKey(storeKey string) *storetypes.MemoryStoreKey {
...
func (app *WasmPlusApp) RegisterNodeService(clientCtx client.Context, cfg config.Config) {
