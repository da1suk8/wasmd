...
func setup(t testing.TB, chainID string, withGenesis bool, invCheckPeriod uint, opts ...wasmkeeper.Option) (*WasmPlusApp, GenesisState) {
	db := dbm.NewMemDB()
	nodeHome := t.TempDir()
...
func Setup(t *testing.T, opts ...wasmkeeper.Option) *WasmPlusApp {
	t.Helper()
